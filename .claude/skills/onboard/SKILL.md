...
`tutor/state/staging/jots.md`: profile facts (background, goals, failure modes
...
writes from the jots — `tutor/state/profile.md`, `tutor/state/topics.yaml`, ledger
files, `tutor/state/syllabus.md`, and the first `session.md` — each ask-gated.
